...
namespace Xams.Core.Repositories
{
    public class DataRepository : IDisposable
    {
        ...
        public DataRepository(Type dataContextType, IDataService dataService)
        {
            ...
            _dataContext.SetDataService(_dataService);
        ...
        public T CreateNewDbContext<T>() where T : IXamsDbContext
        {
            ...
            dbContext.SetDataService(_dataService);
        ...
        private List<dynamic> UpdateFieldPrefixes(List<dynamic> results, ReadInput? readInput = null)
        {
            ...
            foreach (var result in results)
            {
                ...
                foreach (var property in properties)
                {
                    ...
                    {
                        var fieldNameFormatted = fieldName.Substring(alias.Length + 1);
                        fieldName = $"{alias}.{fieldNameFormatted}";
                    }
